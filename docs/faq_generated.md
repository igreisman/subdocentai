...
| Prefix | Meaning |
|--------|---------|
| `der_` | AI-generated FAQ entries **derived from dieselsubs.com** source material. Content is based on the authoritative dieselsubs.com FAQ corpus but rewritten into a new question-and-answer format. These have not been individually expert-reviewed. |
| `pam_` | AI-generated FAQ entries produced by the **pampanito_docent** pipeline from general knowledge. These fill gaps not covered by existing dieselsubs.com material. **Not yet expert-reviewed** — treat with caution. |
| `fix_` | AI-generated entries (originally `pam_`) that have been **expert-reviewed and corrected**. Factual errors identified by subject-matter review have been fixed. These are the most reliable entries in this set. |

---

## fix_ Entries — Expert-Reviewed and Corrected

*Originally `pam_` entries; factual errors have been corrected by expert review.*

### fix_002 — Were there crew bunks in the torpedo rooms?

Were there crew bunks in the torpedo rooms?

Yes. Both the forward torpedo room and the after torpedo room had crew bunks located above the torpedoes. The torpedo rooms doubled as sleeping quarters for some crew members. In the forward torpedo room there are ten reload torpedoes in skids (trays), and the crew bunks are above them. In the after torpedo room, there are four reload torpedoes, and the crew bunks are also above the torpedoes. Sleeping in the torpedo room was an experience — as one crew member described it, his bedfellows were a torpedo on one side and a torpedo below him.

---

### fix_006 — How were torpedo reloads handled at sea?

How were torpedo reloads handled at sea?

Each torpedo room carried spare torpedoes stored on steel skids — tracks running along the sides of the room. When a torpedo was fired and a tube needed to be reloaded, the crew first had to remove the bunks that folded down over the skids. Then three or four men would slide the torpedo along the skid track until it lined up with the open tube, and pull it into the tube using a system of blocks and tackles — pulleys and rope that gave the crew enough mechanical advantage to maneuver the two-thousand-pound weapon in a confined space. It was heavy, awkward work. The Pampanito carried a total of twenty-four torpedoes — six tubes and spare reloads in the forward torpedo room, and four tubes and spare reloads in the after torpedo room. Reloading at sea after a firing could take roughly fifteen to thirty minutes depending on sea conditions and crew experience.

---

### fix_010 — How did sonar work on a WWII submarine?

How did sonar work on a WWII submarine?

WWII submarines used passive sonar — hydrophones — to listen for the sounds of enemy ships. The sonar operator wore headphones and could hear screws turning, machinery noise, and the pinging of enemy active sonar. Passive sonar gave bearing (direction) but not range. Active sonar could send a pulse and measure the echo return time to determine range, but using it revealed the submarine's position to the enemy, so boats were very reluctant to ping actively while hiding. FM sonar was a specialized system — quite separate from general active sonar — designed specifically to detect and navigate around minefields. The sound heads on fleet submarines like the Pampanito were retractable: extended below the keel for use, and pulled back up inside the hull when not needed to protect them from contact damage if the boat came near the bottom. With the heads retracted, the sonar was completely non-functional. A skilled sonar operator could identify different types of ships, estimate their speed, and track multiple contacts.

---

### fix_013 — When was the Pampanito built and launched?

When was the Pampanito built and launched?

USS Pampanito (SS-383) was built at the Portsmouth Naval Shipyard in Kittery, Maine. Her keel was laid on March 15, 1943. She was launched on July 12, 1943 and commissioned into the United States Navy on November 6, 1943. After her commissioning she moved to the Pacific Fleet and began her first war patrol in mid-1944. She was decommissioned on 1 December 1945 and eventually became a maritime museum ship in San Francisco, where she is berthed at Fisherman's Wharf (Pier 45) as part of the San Francisco Maritime National Historical Park.

---

### fix_014 — How did submarine families know if a sailor was still alive on patrol?

How did submarine families know if a sailor was still alive on patrol?

Families at home had very limited information about whether a submarine sailor was safe during a patrol. Submarines maintained radio silence for most of a patrol to avoid detection, so there were no regular communications home. Sailors could write letters, but mail moved under strict limitations. Letters written by crewmen were kept aboard the submarine until it reached a base, where they were then posted home. Letters and packages sent from home to the crew were held at the base until the submarine returned to port — the crew received their mail only when the boat came back in. When a submarine arrived in port, sailors were sometimes allowed to send a brief cable home. If a submarine was overdue and presumed lost, the Navy would notify the families that the boat was missing. The phrase "on eternal patrol" was used to describe submarines and their crews that never came home. No news was generally considered good news — families knew that if the submarine were lost, the Navy would eventually notify them.

---

### fix_015 — What is a depth charge and how did it work?

What is a depth charge and how did it work?

A depth charge is an anti-submarine weapon — essentially a canister filled with high explosive (TNT or Torpex) designed to sink to a set depth before detonating. Surface ships dropped them off the stern or launched them from projectors called K-guns, creating a pattern of explosions around a suspected submarine location. The fuse was set to detonate at a specific depth, calibrated before launching using a pressure-activated mechanism. The explosion didn't have to directly hit the submarine — the concussion and pressure wave from a nearby blast could rupture hull welds, crack pipes, shatter gauge glasses, and kill or injure crew members. A very close depth charge could tear open the pressure hull, allowing seawater to pour in faster than any crew could respond. The sound inside a submerged submarine under depth charge attack was described by survivors as deafening and terrifying — every loose object flew, lights shattered, and the whole hull shuddered with each explosion.

---

### fix_016 — Were submarine crews paid more than regular Navy sailors?

Were submarine crews paid more than regular Navy sailors?

Yes, submarine sailors received extra pay specifically because of the dangerous and demanding nature of submarine service. This was called submarine pay or hazardous duty pay. The Pay Readjustment Act of 1942 established submarine pay at 50% of base pay for both officers and enlisted men. Before that legislation, qualified submariners received $10 per month and non-qualified submariners $5 per month, plus $1 for each day spent submerged. Rather than a personal food allowance, ration money was allocated to the boat itself to buy food for the crew — managed by a Supply Officer who was typically a regular line officer carrying supply as a collateral duty, not a specialist. That arrangement gave the cook real purchasing authority, which is one reason submariners were famous for eating better than most sailors in the Navy. The combination of higher pay, better food, and a strong sense of camaraderie made submarine service attractive despite the obvious dangers.

---

### fix_018 — How did the crew breathe fresh air inside a submerged submarine?

How did the crew breathe fresh air inside a submerged submarine?

When on the surface, the submarine's diesel engines drew fresh air through the boat via the main induction system, keeping the interior well ventilated. Once the boat dived, that connection was sealed and the crew lived on a fixed air supply. Carbon dioxide accumulated steadily as the men breathed; no new oxygen entered the boat. If a prolonged dive — usually forced by a depth-charge attack — pushed air quality to dangerous levels, emergency oxygen bottles could be cracked open and cans of CO2 absorbent (soda lime) deployed to scrub the atmosphere. These were one-time emergency measures, not a continuous life-support system. Hydrogen gas, a byproduct of charging batteries, was another hazard that required careful management whenever possible.

The air grew progressively stale and thick on a long dive. In a serious depth-charge attack that forced the boat to stay down for many hours, CO2 levels could rise to dangerously uncomfortable levels — heads throbbed, men moved slowly, speech slurred. The submarine's time underwater was thus limited by both battery charge and breathable air. As soon as conditions permitted, the boat surfaced and opened the main induction valve to flush the interior with fresh sea air.

---

### fix_024 — What happened to the Pampanito after WWII ended?

What happened to the Pampanito after WWII ended?

After Japan's surrender in August 1945, USS Pampanito was decommissioned from active service on 1 December 1945. She spent years in the Pacific Reserve Fleet before being reassigned to the Naval Reserve as a training vessel, giving future submariners hands-on experience in a fleet boat.

In 1976 she was transferred to the city of San Francisco and the National Maritime Museum Association (later the Maritime Park Association), which undertook years of restoration work to preserve her in a condition as close as possible to her wartime configuration. She was opened to the public as a museum ship and is today berthed permanently at Pier 45. In 1986 she was designated a National Historic Landmark.

Pampanito is one of only a handful of WWII fleet submarines still in existence and open for public tours, making her an irreplaceable piece of American naval history.

---

### fix_029 — How could submariners escape from a submarine sunken on the bottom?

How could submariners escape from a submarine sunken on the bottom?

Escape from a sunken submarine was deeply difficult and rarely successful. The main individual device was the Momsen lung, a small rubber rebreather carried by each sailor. To use it, crew members entered the escape trunk — a small compartment with a lower and upper hatch — flooded it to equalize pressure with the sea, then opened the upper hatch and ascended while exhaling continuously to prevent their lungs from over-expanding as water pressure decreased.

The method was practiced and did work at depths up to about 200 feet. Beyond that, the physiological risks of rapid ascent (air embolism, decompression sickness) became severe. Newer submarines also had built-in escape trunks large enough for one or two men at a time.

In practice, the vast majority of the 52 US submarines lost in WWII went down suddenly — explosions, depth charges, aerial bombs — giving the crew no time to use escape equipment. Of the more than 3,500 American submariners killed in the war, almost none escaped from boats sunk in combat. Escape training was critical, but survival was more often a matter of the submarine not getting hit in the first place.

---

### fix_037 — What was the toilet like on a submarine?

What was the toilet like on a submarine?

On a submarine, the toilet is called the “head” — standard Navy terminology. A fleet submarine like the Pampanito had four heads: one in the forward torpedo room used primarily by officers, two in the after battery berthing area, and one in the after torpedo room. For 80 men, that was limited but usually adequate.

Three of the four heads drained into sanitary tanks — sealed holding tanks below decks that were discharged when the submarine surfaced. Using these while submerged was relatively straightforward: fill the bowl with water and allow it to drain into the tank. The fourth head — in the after torpedo room — was different entirely. It discharged directly overboard and could not be used in port or while submerged. At sea on the surface, waste had to be blown outboard against sea pressure using compressed air, because the outlet sat well below the waterline. The procedure required a specific eight-step sequence of valves and levers, and a sign was posted explaining each step. Getting the sequence wrong could result in sewage being blown back into the boat. Most veteran submariners have a story about this happening to someone.

The combination of the limited number of heads, the complicated procedure for the after torpedo room head in particular, and the need to queue during busy periods made the head situation one of the reliable inconveniences of submarine life.

---

## der_ Entries — Derived from dieselsubs.com

*AI-generated from dieselsubs.com source material; not individually expert-reviewed.*

### der_001 — What was the purpose of the maneuvering room?

What was the purpose of the maneuvering room?

The maneuvering room was the control center for the submarine’s propulsion. That’s where they controlled the engine speed and the load on the engine. Speed changes and direction changes of the propellers took place here. The large levers switched the electricity from the submarine’s generators to either charge the batteries or power the main propulsion motors. When submerged, the levers were changed to take power from the battery to operate the boat. The submarine’s electric motors drove the twin propellers.

---

### der_003 — What kind of engines does the Pampanito have?

What kind of engines does the Pampanito have?

The Pampanito has four Fairbanks-Morse model 38D8-1/8 opposed-piston diesel engines. They are ten-cylinder engines with two crankshafts — one on top and one on the bottom — which is what makes them 'opposed piston.' Two engines are in the after engine room and two more are in the forward engine room. Together they produce about 5,400 horsepower. The diesel engines do not drive the propellers directly. Instead, they drive generators that produce electricity. That electricity either charges the batteries or powers the electric motors that turn the propellers. When submerged, the diesel engines cannot run because they need air; the submarine ran on battery power underwater.

---

### der_004 — Were submariners smarter than other sailors?

Were submariners smarter than other sailors?

Submarine service attracted volunteers who were motivated, technically capable, and willing to serve in confined, high-risk conditions. Every submariner was a volunteer — no one was assigned to submarines against their will. Candidates had to pass a physical exam and a psychological screening to confirm they could handle the stress and close quarters of submarine life. Officers and enlisted men had to qualify in submarines, which meant learning every system on the boat well enough to operate it and save the ship in an emergency. That qualification process was demanding and not everyone made it through. Whether submariners were 'smarter' is debatable, but they were highly trained, self-selected volunteers who took great pride in their service.

---

### der_005 — How was food stored on board a submarine?

How was food stored on board a submarine?

Food was stored throughout the boat to take advantage of every available space. The main dry goods storage room was directly below the galley deck — you accessed it through a trapdoor, and the shelves were packed from top to bottom; a fully loaded boat filled that well all the way up. Canned food was also stowed outboard of the engines in the engine rooms, packed into the spaces around the machinery. Fresh food and frozen items were kept in a small refrigerator and freezer, also located beneath the crew's mess area under a separate trapdoor. At the start of a two-month patrol the submarine was loaded to capacity; canned goods were sometimes stacked on the deck plates and walkways until the crew ate through them and space opened up. Personal storage for sailors was extremely limited — not much room for two months at sea.

---

### der_007 — How could a submarine run underwater if diesel engines needed air?

How could a submarine run underwater if diesel engines needed air?

World War II submarines like the Pampanito were diesel-electric boats, not purely diesel-powered ones. The diesel engines could only run on the surface, where they had access to fresh air. On the surface, the diesels drove generators that produced electricity — and that electricity charged large storage batteries located below the crew berthing decks. When the submarine dived, the diesel engines shut down completely. Underwater, the boat ran entirely on battery power, using electric motors to turn the propellers. The batteries could propel the submarine silently for many hours, though speed and depth affected how long they lasted. When the batteries ran low, the submarine had to return to the surface or to periscope depth to run the diesels and recharge. During wartime patrols this made the boat vulnerable, so recharging was usually done at night. The maneuvering room controlled the switching between diesel power and battery power.

---

### der_008 — Why were WWII submarines usually on the surface at night?

Why were submarines usually on the surface at night instead of staying submerged?

Fleet submarines like the Pampanito ran on diesel engines while on the surface and electric motors while submerged. Because diesel engines need air to run, the boat had to surface regularly to recharge the batteries that powered the electric motors underwater. Nighttime was much safer for surfacing because aircraft couldn't spot the submarine as easily in the dark. On the surface at night, the crew could run the diesels to recharge the batteries, travel at higher speed (surface speed was about three times faster than submerged speed), ventilate the boat with fresh air, and receive radio messages. Staying submerged on battery power was necessary to avoid detection, but submarines had to surface at night to recharge and cover ground.

---

### der_009 — How did submarines navigate underwater without GPS?

How did submarines navigate underwater without GPS?

WWII submarines navigated by a combination of dead reckoning, celestial observation, and fathometer (depth sounder) readings. Dead reckoning meant the navigator tracked the boat's known speed, heading, and time elapsed since the last confirmed position to continuously update an estimated position on the chart. Whenever the submarine was on the surface at night, the navigator could take star or celestial sights with a sextant to get an accurate fix. Depth soundings from the fathometer could confirm position by matching the sea floor contour to navigation charts. When operating close to land, landmarks or lighthouses could also be used. Submarines accepted a degree of positional uncertainty underwater — accuracy improved each time they surfaced to take a proper celestial fix.

---

### der_011 — Could the crew send radio messages to other submarines while submerged?

Could the crew send radio messages to other submarines while submerged?

WWII submarines could not communicate by radio while submerged because radio waves do not penetrate seawater. The only form of underwater communication available was the underwater telephone, called Gertrude or the UQC, which transmitted voice through the water using sonar frequencies. However, Gertrude had very limited range — typically only a few miles — and using it risked revealing the submarine's position to the enemy. In practice, submarines operating together in wolfpacks communicated primarily by radio while on the surface at night. During submerged operations each boat was essentially on its own. Messages from fleet command were sent via low-frequency radio to submarines at periscope depth or near the surface, where the antenna could be raised just above the waterline.

---

### der_012 — How many ships did the Pampanito sink and what is she most famous for?

How many ships did the Pampanito sink and what is she most famous for?

USS Pampanito (SS-383) completed six war patrols during World War II and is credited with sinking six Japanese ships and damaging four others. She is most famous for an extraordinary rescue mission in September 1944 during her third war patrol. Pampanito and other submarines in a wolfpack attacked a Japanese convoy in the South China Sea and sank several ships — not knowing that the enemy vessels were transporting British and Australian prisoners of war captured at the fall of Singapore. When the submarines returned to the area two days later, they found hundreds of survivors clinging to wreckage. Pampanito rescued 73 survivors and the entire group of submarines saved 159 Allied prisoners of war from the sea. It remains one of the most dramatic rescue operations in submarine history.

---

### der_067 — How many torpedoes did a submarine carry?
...
### der_068 — What was the temperature like inside a submarine?
...
### der_069 — How loud was it inside a submarine?
...
### der_070 — How long was a typical war patrol?
...
### der_071 — What did the crew do when they spotted an enemy ship?
...
### der_072 — Did submarines ever fight other submarines?
...
### der_073 — What was the largest submarine in WWII?
...
### der_074 — Did submarines ever carry troops or special forces?
...
### der_076 — How did the crew handle doing laundry?
...
### der_077 — Did the Pampanito crew get shore leave?
...
### der_078 — What ports did the Pampanito operate from?
...
### der_079 — What was the Mark 14 torpedo?
...
### der_080 — What happened to the crew after the war?
...
### der_081 — Were Pampanito crew members awarded medals?

Were Pampanito crew members awarded medals?
...
### der_082 — How much fuel did a submarine carry?
...
### der_083 — What happened if a submarine got stuck on the bottom?
...
### der_084 — What was the diving alarm sound?
...
### der_085 — What was the battery room on a submarine?

What was the battery room on a submarine?

Fleet submarines like the Pampanito had two battery rooms — called the forward battery and the after battery — located in the lower hull, directly beneath the berthing areas. Each battery room held 126 large lead-acid battery cells, for a total of 252 cells in the whole boat.
...
### der_086 — How did the crew detect and track enemy ships?

How did the crew detect and track enemy ships?
...
### der_087 — How far could a submarine travel on one fuel load?
...
### der_088 — What kind of food did the crew eat on a submarine?
...
### der_089 — What was a submarine tender?
...
### der_090 — What does the SS in USS Pampanito SS-383 stand for?

What does the SS in USS Pampanito SS-383 stand for?
...
### der_091 — How did the crew know survivors in the water were Allied prisoners?
...
### der_092 — Were there doctors on submarines?
...
### der_093 — What was submarine school in Groton Connecticut?
...
### der_095 — How did submarines help win the war?

How did submarines help win the war?
...
### der_096 — How did submarines receive their patrol assignments?
...
### der_097 — Was the Pampanito ever damaged in combat?
...
### der_098 — What was the Pampanito doing at the end of the war?
...
### der_099 — How was the Pampanito decommissioned and preserved as a museum?
...
### der_100 — What was the commissioning of a submarine?
...
### der_101 — How long can a submarine stay submerged and what was the longest?
...
### der_102 — Were there discipline problems on submarines?

Were there discipline problems on submarines?
...
### der_103 — What was the Pacific Fleet submarine strategy in WWII?

What was the Pacific Fleet submarine strategy in WWII?
...
### der_104 — How was the Pampanito resupplied at sea?
...
### der_105 — What was the hull number of the Pampanito?
...
### der_106 — Were there doctors or medical care on submarines?

Were there doctors or medical care on submarines?
...
### der_107 — How did submarines handle medical emergencies at sea?
...
### der_108 — Did the Pampanito ever hit a mine?
...
### der_109 — When was the Pampanito decommissioned?

When was the Pampanito decommissioned?
...
### der_110 — How did radar work on a WWII submarine?
...
### der_111 — Who donated the Pampanito to the museum?

Who donated the Pampanito to the museum in San Francisco?
...
### der_112 — What was the longest any submarine stayed submerged?
...
### der_113 — What was the lifeguard mission in WWII?
...
### der_114 — Did submarines lay mines in WWII?

Did submarines lay mines in WWII?
...
### der_115 — How did a depth charge attack feel inside a submarine?
...
### der_116 — What was hot bunking on a submarine?
...
### der_117 — How did the deck gun work on a submarine?

How did the deck gun work on a submarine?
...
### der_118 — How did the Pampanito get its name?
...
### der_119 — How did submarine crews handle a fire onboard?
...
### der_120 — Did American WWII submarines have a snorkel?

Did American WWII submarines have a snorkel?
...
### der_121 — What was the role of submarines in the Battle of Midway?

What was the role of submarines in the Battle of Midway?
...
### der_122 — What was radio direction finding and how did it threaten submarines?
...
### der_123 — How did the crew deal with claustrophobia on a submarine?

How did the crew deal with claustrophobia on a submarine?
...
### der_124 — What was the galley like on a submarine?
...
### der_125 — How did submarine crews get fresh water?
...
### der_126 — Was the Pampanito ever close to being sunk?
...
### der_127 — How did submarines attack a convoy?

How did submarines attack a convoy?
...
### der_128 — How did the crew handle seasickness on a submarine?
...
### der_129 — Did the Pampanito sink Japanese warships?

Did the Pampanito sink Japanese warships?
...
### der_130 — How did submarines handle the threat of aircraft?
...
### der_131 — What were wolfpack tactics in WWII submarines?
...
### der_132 — Were submarines used to land spies or special forces?
...
### der_133 — What did the captain do during a depth charge attack?
...
### der_134 — How did the crew communicate with each other inside the submarine?
...
### der_135 — What did crew members wear on a submarine?
...
### der_136 — What did it mean to be qualified in submarines?

What did it mean to be qualified in submarines?
...
### der_137 — What was the submarine combat patrol insignia?

What was the submarine combat patrol insignia?
...
### der_138 — How did the Pampanito crew rescue the POWs from the water?

How did the Pampanito crew rescue the POWs from the water?
...
### der_139 — What was the role of the executive officer on a submarine?
...
### der_140 — What were battle stations on a submarine?
...
### der_141 — What was the role of the pharmacists mate on a submarine?
...
### der_142 — Did any American submarines get captured by the enemy?
...
### der_143 — What was a ballast tank on a submarine?
...
### der_144 — What was a war patrol report?
...
### der_145 — How did submarines avoid enemy minefields?
...
### der_147 — How did submarines recharge their batteries?
...
### der_148 — What was the difference between a Gato and a Balao class submarine?
...
### der_149 — What were the daily duties of the captain of a submarine?
...
### der_150 — How did submarines handle the threat of enemy destroyers?

How did submarines handle the threat of enemy destroyers?
...
### der_151 — What was the sound of a torpedo being fired?
...
### der_152 — What was commissioning day like for a new submarine?
...
### der_153 — What happened to Japanese submarines at the end of WWII?

What happened to Japanese submarines at the end of WWII?
...
### der_154 — What happened if a crew member died while on patrol?
...
### der_155 — How did submarines get their orders for each war patrol?
...
### der_156 — What was the control room used for on a submarine?
...
### der_157 — What did the forward torpedo room look like?
...
### der_158 — How did the crew dispose of garbage on a submarine?
...
### der_159 — What happened to enemy survivors after a submarine attack?
...
### der_160 — How did submarines handle fires or flooding emergencies?
...
### der_161 — What was a periscope feather?
...
### der_162 — How did the crew deal with boredom on a long patrol?

How did the crew deal with boredom on a long patrol?
...
### der_163 — What was the role of the TDC operator on a submarine?

What was the role of the TDC operator on a submarine?
...
### der_164 — What happened if a submarine ran aground?
...
### der_165 — What did a Japanese convoy look like?
...
### der_166 — How did the Pampanito earn her battle stars?
...
### der_167 — What was the flying bridge on a submarine?
...
### der_168 — How deep could the Pampanito dive?
...
### der_169 — What was the magnetic exploder problem with US torpedoes?
...
### der_170 — Who was the most successful US submarine commander of WWII?
...
### der_171 — How did the crew celebrate after a successful attack?
...
### der_172 — What did submariners do when they returned to port after a patrol?

What did submariners do when they returned to port after a patrol?
...
### der_173 — Why were submarines called the Silent Service?
...
### der_174 — How did submarine construction change during the war?
...
### der_175 — What was a snorkel on a submarine?
...
### der_176 — What was periscope depth on a submarine?

What was periscope depth on a submarine?
...
### der_177 — What was the officer of the deck responsible for on a submarine?

What was the officer of the deck responsible for on a submarine?
...
### der_178 — What was a conning tower on a submarine?
...
### der_179 — How were new submarine crew members trained?
...
### der_180 — What was a sound-powered telephone on a submarine?

What was a sound-powered telephone on a submarine?
...
### der_181 — How did submarines identify enemy ships at night?
...
### der_182 — What was the after torpedo room used for on a submarine?

What was the after torpedo room used for on a submarine?
...
### der_183 — How did the Navy select men for submarine duty?

How did the Navy select men for submarine duty?
...
### der_184 — What happened to the crew of a submarine that was sunk?

What happened to the crew of a submarine that was sunk?
...
### der_185 — How did submarines attack targets at night on the surface?

How did submarines attack targets at night on the surface?
...
### der_186 — What did the lookouts on a submarine watch for?
...
### der_187 — How were submarines refueled in the Pacific?
...
### der_188 — What was a target's angle on the bow?
...
### der_189 — How did submarines communicate with Pearl Harbor during a patrol?

How did submarines communicate with Pearl Harbor during a patrol?
...
### der_190 — What was the forward engine room on a submarine?

What was the forward engine room on a submarine?
...
### der_191 — How did submarines navigate to their patrol areas from Pearl Harbor?

How did submarines navigate to their patrol areas from Pearl Harbor?
...
### der_192 — How did submarine captains decide when to surface?
...
### der_193 — What was the escape trunk on a submarine?

What was the escape trunk on a submarine?
...
### der_194 — How did sonar operators track enemy ships on a submarine?

How did sonar operators track enemy ships on a submarine?
...
### der_195 — What was the role of the chief of the boat on a submarine?
...
### der_196 — How did torpedo spreads work on a submarine?

How did torpedo spreads work on a submarine?
...
### der_197 — How did submarines work together to avoid colliding with each other?

How did submarines work together to avoid colliding with each other?
...
### der_198 — How did a submarine conduct a periscope attack step by step?

How did a submarine conduct a periscope attack step by step?
...
### der_199 — What was the after engine room on a submarine?
...
### der_200 — What were the diving planes on a submarine and how did they work?

What were the diving planes on a submarine and how did they work?
...
### der_201 — How did submarines use radar during World War II?
...
### der_202 — How did submarine crews cope with the heat in the tropics?
...
### der_203 — What qualities made a successful submarine commander?

What qualities made a successful submarine commander?
...
### der_204 — What was it like inside a submarine during a depth charge attack?

What was it like inside a submarine during a depth charge attack?
...
### der_205 — How did submarines evade destroyers and anti-submarine escorts?

How did submarines evade destroyers and anti-submarine escorts?
...
### der_206 — Why were aircraft such a dangerous threat to submarines?

Why were aircraft such a dangerous threat to submarines?
...
### der_207 — What were wolfpack tactics and how did the US Navy use them?

What were wolfpack tactics and how did the US Navy use them?
...
### der_208 — Did US submarines ever sink enemy submarines?

Did US submarines ever sink enemy submarines?
...
### der_209 — What was the difference between a magnetic exploder and a contact exploder on a torpedo?

What was the difference between a magnetic exploder and a contact exploder on a torpedo?
...
### der_210 — How effective was Japanese anti-submarine warfare against US submarines?
...
### der_211 — What was a submarine tender and what did it provide to submarines?
...
### der_212 — Why did the Mark 14 torpedo have a depth-running failure and run deeper than set?

Why did the Mark 14 torpedo have a depth-running failure and run deeper than set?
...
### der_213 — How did ULTRA codebreaking intelligence help US submarines find targets?
...
### der_214 — What was a down-the-throat shot on a submarine?
...
### der_215 — How did mines threaten US submarines and how did crews cope?

How did mines threaten US submarines and how did crews cope?
...
### der_216 — Were the sinking claims made by US submarines accurate?

Were the sinking claims made by US submarines accurate?
...
### der_217 — What was the overall strategic impact of the US submarine campaign?

What was the overall strategic impact of the US submarine campaign?
...
### der_218 — How did a torpedo tube work to launch a torpedo?

How did a torpedo tube work to launch a torpedo?
...
### der_219 — What was the forward battery compartment and why did officers live there?

What was the forward battery compartment and why did officers live there?
...
### der_220 — Were any submarine crew members awarded the Medal of Honor in World War II?

Were any submarine crew members awarded the Medal of Honor in World War II?
...
### der_221 — How did submarine crews send and receive mail during war patrols?

How did submarine crews send and receive mail during war patrols?
...
### der_222 — Why did submarines use their deck guns to attack surface targets instead of torpedoes?

Why did submarines use their deck guns to attack surface targets instead of torpedoes?
...
### der_223 — What was the difference between the conning tower and the control room?
...
### der_224 — What was a Presidential Unit Citation and how did the Pampanito earn one?
...
### der_225 — Why did submarines have two periscopes and what was each one for?

Why did submarines have two periscopes and what was each one for?
...
### der_226 — How many ships did the USS Pampanito sink and what was her war record?

How many ships did the USS Pampanito sink and what was her war record?
...
## pam_ Entries — pampanito_docent Generated

*AI-generated from general knowledge; not yet expert-reviewed.*

### pam_017 — How did the crew know where they were during a patrol?

How did the crew know where they were during a patrol?

WWII submarines navigated by a combination of dead reckoning, celestial observation, and fathometer (depth sounder) readings. Dead reckoning meant the navigator tracked the boat's known speed, heading, and time elapsed since the last confirmed position to continuously update an estimated position on the chart. Whenever the submarine was on the surface at night, the navigator could take star or celestial sights with a sextant to get an accurate fix. Depth soundings from the fathometer could confirm position by matching the sea floor contour to navigation charts. When operating close to land, landmarks or lighthouses could also be used. Submarines accepted a degree of positional uncertainty underwater — accuracy improved each time they surfaced to take a proper celestial fix.

---

### pam_019 — How did a WWII torpedo work?

How did a WWII torpedo work?

A WWII torpedo was a self-propelled underwater weapon about 21 inches in diameter and 20 feet long. The standard US weapon was the Mark 14 steam torpedo, driven by a turbine burning a mixture of compressed air, water (converted to steam), and alcohol fuel. It traveled at about 45 knots and had a range of around 4,500 yards on its high-speed setting.

A gyroscope inside kept it running straight on a preset heading at a preset depth, maintained by a hydrostatic valve that adjusted the rear fins. The warhead detonated on contact via a firing pin, or in theory via a magnetic influence exploder that was supposed to trigger beneath the hull of a ship.

Early in the war, US torpedoes were plagued by two serious defects: the magnetic exploder fired prematurely or not at all, and the contact exploder pins would shear on a direct hit, also failing to fire. These flaws went unacknowledged for over a year and cost countless opportunities. By 1943 the problems were finally corrected, and torpedo performance improved dramatically for the rest of the war.

---

### pam_020 — What weapons did submarines carry besides torpedoes?

What weapons did submarines carry besides torpedoes?

WWII US fleet submarines carried a deck gun as their main secondary weapon — typically a 4-inch or 5-inch gun mounted forward of the conning tower, plus 40mm and 20mm anti-aircraft guns on the bridge. The Pampanito carried a 4-inch .50-caliber deck gun.

The deck gun was used to sink small surface targets — sampans, fishing vessels, lifeboats transporting troops, and small coastal freighters — when using a torpedo would be wasteful. It was also used to finish off ships that had been torpedoed but refused to sink. Surface gun attacks required the submarine to remain exposed on the surface within range of return fire, so they were reserved for situations where the risk was acceptable.

Anti-aircraft guns provided defense against low-flying patrol aircraft, which were a constant threat to surfaced submarines, especially as the war progressed and Allied airpower increased in the Pacific. By late 1944 many submarine losses were to aircraft, making anti-aircraft capability critical.

---

### pam_021 — How did the captain decide to fire torpedoes at a target ship?

How did the captain decide to fire torpedoes at a target ship?

A submarine attack began with detection — a sonar contact, a periscope sighting, or a radio tip about a convoy. The captain would track the target by taking repeated periscope observations, noting bearing, estimated speed, and course. The Torpedo Data Computer (TDC), an electromechanical analog computer in the conning tower, continuously calculated the firing solution: the correct torpedo gyro angle to intercept the target.

The submarine maneuvered to close the range and achieve a favorable firing angle — ideally perpendicular to the target's course, known as a 90-degree track, giving the best chance of a hit. When the captain was satisfied with the solution, he ordered a spread of two to four torpedoes fired with a small angular spread timed to compensate for any course errors.

After firing, the submarine immediately went deep and turned away to evade the counterattack from destroyer escorts. The depth charges that followed could last for hours. A successful attack used four to six of the submarine's twenty-four torpedoes, so fire discipline was essential — every torpedo had to count.

---

### pam_022 — Where is the Pampanito?

Where is the Pampanito?

USS Pampanito (SS-383) is permanently moored at Pier 45, Fisherman's Wharf, San Francisco, California. She is operated as a museum ship by the Maritime Park Association and is part of the San Francisco Maritime National Historical Park.

Visitors can board and walk through the entire length of the submarine, from the after torpedo room to the forward torpedo room. A self-guided audio tour — the same one you may be listening to right now — is available and takes approximately 45 to 60 minutes. The tour features the voices of officers and crew who actually served on Pampanito and other US submarines during World War II.

Admission is charged; current hours and ticket prices are posted at the pier. The ship is ADA accessible to a limited extent on the exterior decks, but the interior requires climbing through narrow hatches and ladder access, as on the original vessel.

---

### pam_023 — What class of submarine is the Pampanito and what does that mean?

What class of submarine is the Pampanito and what does that mean?

USS Pampanito (SS-383) is a Balao-class fleet submarine, one of the most-produced submarine types of World War II. The Balao class was an evolution of the earlier Gato class, with the primary improvement being a thicker, higher-yield steel pressure hull that increased the safe test depth from 300 feet (Gato) to 400 feet. This extra margin was operationally significant — it gave crews more room to dive away from depth charges.

Balao-class submarines were approximately 311 feet long, displaced around 2,400 tons submerged, and carried a crew of 80 to 85 men. They were armed with ten torpedo tubes (six forward, four aft) and carried 24 torpedoes plus a deck gun and anti-aircraft guns. Over 120 Balao-class submarines were commissioned during the war, making them the backbone of the US Pacific submarine fleet.

---

### pam_025 — How deep could a WWII submarine dive?

How deep could a WWII submarine dive?

The Balao-class submarines like the Pampanito had a designed test depth of 400 feet — the depth the Navy certified as safe for normal operations. The maximum "crush depth," where the hull would fail under sea pressure, was estimated at roughly 600 feet or more, but no one wanted to find out exactly where that line was.

In practice, submarines under depth-charge attack sometimes went well below their rated test depth in desperation, and some survived. The hull creaked and groaned under the added pressure, valves leaked, and lights flickered — but well-constructed boats sometimes made it back. Others did not. Gato-class submarines, the earlier generation, had a shallower test depth of 300 feet, making them more vulnerable.

The ability to dive quickly and deeply was one of the submarine's most important survival tools when attacked by surface ships.

---

### pam_026 — How fast could submarines go?

How fast could submarines go?

On the surface, a fleet submarine like the Pampanito could make about 20 knots (roughly 23 mph) using her four diesel engines — fast enough to race ahead of most convoys and get into position for an attack. Transit speed on long patrols was typically slower, around 10 to 14 knots, to conserve fuel.

Submerged, the submarine ran on battery power and was considerably slower. Top speed underwater was about 8 to 9 knots, but that pace drained the batteries within an hour. A sustainable submerged patrol speed was 2 to 3 knots, which could stretch battery life to 48 hours or more before requiring surfacing to recharge.

This speed gap between surface and submerged operation was a defining tactical limitation of WWII diesel submarines. A submarine that found itself on the wrong side of a fast destroyer could not outrun it underwater — the only option was to dive deep and evade, or be very lucky.

---

### pam_027 — What was the watch schedule like on a WWII submarine?

What was the watch schedule like on a WWII submarine?

Life on a WWII submarine was organized around four-hour watches rotating around the clock: midnight to 4 AM, 4 to 8 AM, 8 to noon, noon to 4 PM, 4 to 8 PM, and 8 PM to midnight. The crew was divided into three watch sections, with about one-third of the men on duty at any time. The other two-thirds ate, slept, maintained equipment, or stood by.

Sleep came whenever it could — WWII submariners rarely slept a full eight-hour stretch. Bunks were shared in rotation, a practice called hot-racking: one man came off watch, and the bunk he took was still warm from the man who had just left for duty. There was no such thing as a personal bunk on a crowded fleet boat.

When the alarm sounded for general quarters — battle stations — every man in the crew went immediately to his designated post, regardless of what he had been doing. After a night attack and depth-charge evasion, some men might go eighteen hours without sleep.

---

### pam_028 — How long did it take to train a submarine crew?

How long did it take to train a submarine crew?

Submarine training in WWII was compressed by wartime urgency. After completing 8 weeks of basic Navy training, enlisted volunteers attended the Navy Submarine School in New London, Connecticut — a course of roughly three months that covered diving, escape procedures, submarine systems, and watch-standing duties. Officers went through a separate three-month program tailored to their duties.

After reporting to an actual boat, a new crew member began the qualification process — earning the right to wear the submarine warfare insignia, the "dolphins." Qualification meant demonstrating that you understood and could operate every system on the submarine well enough to take over in an emergency. You had to be able to close any valve, operate any piece of machinery, and explain what every pipe and wire did. This typically took another four to six months aboard.

Submarine service was always voluntary. Any man who decided submarine duty was not for him was transferred ashore without prejudice — the Navy did not want reluctant men in an environment where everyone had to be completely committed.

---

### pam_030 — How did submarine crews manage hygiene and bathing on a long patrol?

How did submarine crews manage hygiene and bathing on a long patrol?

Fresh water on a WWII submarine was extremely scarce. Every drop was either carried in tanks at the start of patrol or produced by the sub's small evaporator, and the priority was always drinking water for the crew and cooling water for the engines. There was almost none left over for bathing.

Showering was a luxury most submariners went without for weeks at a time. When a wash was possible, it was a quick sponge bath or a brief rinse — not a real shower. Laundry was equally impossible; clothes were worn repeatedly and then stuffed away. The boat itself was permeated with the combined smells of diesel fuel, machine oil, cooking, and unwashed men in a confined space.

Veterans recall that they could tell when a submarine was returning to port not just by sight but by smell. After a 60-day war patrol, the men coming off the boat looked — and needed — a very long shower, a hot meal, and a few days' rest ashore before they looked anything like themselves again.

---

### pam_031 — Were women allowed to serve on submarines in WWII?

Were women allowed to serve on submarines in WWII?

No. During World War II, the US Navy did not allow women to serve on submarines or on any combat vessel. Women served in the WAVES (Women Accepted for Volunteer Emergency Service), working in crucial shore-based roles — as cryptographers, mechanics, yeomen, air traffic controllers, and in other positions that freed men for sea duty. Their contributions to the war effort were significant, but their assignments were on land or at naval stations, not aboard ships.

Practical realities reinforced the policy on submarines: a fleet boat on a 60-day patrol had no privacy whatsoever, minimal sanitation facilities, 80-plus men in a steel tube the size of an apartment building's hallway, and living conditions that were barely tolerable even for people who had volunteered for exactly that.

The US Navy finally began integrating women into the submarine service in 2010, starting with officers. Enlisted women followed in 2012. Today women serve throughout the submarine fleet, including on ballistic missile submarines.

---

### pam_032 — Did submarines have a deck gun aboard?

Did submarines have a deck gun aboard?
...
### pam_033 — How did a submarine attack a ship?

How did a submarine attack a ship?
...
### pam_034 — Can I visit the Pampanito?

Can I visit the Pampanito?
...
### pam_035 — How many people were in a WWII submarine crew?

How many people were in a WWII submarine crew?

A US fleet submarine like the Pampanito carried about 80 men — roughly 10 officers and 70 enlisted sailors. The Balao class, to which Pampanito belongs, had a maximum complement of 85, though wartime patrols often ran slightly under that.

In a vessel 311 feet long and less than 28 feet at its widest, those 80 men lived, slept, worked, ate, and stood watch in conditions of extraordinary crowding. There were never enough bunks for everyone at the same time, which is why the “hot bunk” system was used — a sailor coming off watch would climb into the bunk just vacated by someone going on watch, the mattress still warm.

Despite the cramped conditions, a submarine crew functioned as a highly trained team. Every man had to qualify in every major system aboard — not just his own job. In an emergency, you might need any sailor to operate any piece of equipment. The Navy’s word for this was “qualified in submarines,” and earning it was a point of pride.

---

### pam_036 — What did the crew do for fun on a long patrol?

What did the crew do for fun on a long patrol?

The crew’s mess — the small dining area in the middle of the boat — doubled as the only real recreation space on a fleet submarine. When men weren’t eating, sleeping, or standing watch, this is where they gathered.

Card games were the most popular pastime: poker, cribbage, acey-deucey (a Navy version of backgammon), and checkers. Many boats had a small record player or phonograph for music. Reading paperback books was common — crewmen shared novels and magazines until they fell apart. In the later years of the war, some submarines were equipped with a 16mm movie projector, and a rotation of films would be screened in the crew’s mess.

Patrol days were long and mostly routine. Ninety percent of a patrol was spent transiting to and from the patrol area, or waiting submerged during daytime hours. Men on the day watch might have several hours of free time. The boredom was interrupted by drills, maintenance, and — when it came — the sudden controlled chaos of a potential contact or attack. Veterans often recall that the monotony was harder to endure than the danger.

---

### pam_038 — How did a submarine surface from underwater?

How did a submarine surface from underwater?

To surface, a submarine “blew” its ballast tanks — forcing out the seawater that made the boat heavy enough to submerge in the first place. High-pressure air stored in large banks of cylinders on the submarine was routed into the main ballast tanks, pushing the water out through flood holes in the bottom. As the tanks filled with air, buoyancy increased and the boat rose toward the surface.

Once the submarine broached — broke the surface — the bridge watch would open the conning tower hatch as soon as it was safe, and the lookouts and officer of the deck would climb topside to begin watching for aircraft and other threats. Surfacing was a vulnerable moment because the boat wasn’t yet moving fast enough to dive quickly if a threat appeared.

The diesel engines would be started as soon as the induction mast was clear of the water, beginning the process of charging the batteries for the next submerged period. On the surface, the diesels ran constantly — the submarine used one or two engines to drive the boat and the others to charge batteries.

---

### pam_039 — What was the procedure for an emergency dive?

What was the procedure for an emergency dive?

An emergency dive — called a “crash dive” — was practiced constantly until the entire crew could execute it in their sleep. Typically triggered by a sighting of an enemy aircraft or surface ship, the goal was to get below the surface as fast as possible.

The diving alarm — two blasts of the klaxon, the distinctive “ah-OOH-ga” sound — was the signal. Every man on the bridge scrambled below in a fixed order: lookouts first, then the officer of the deck, then the captain last, pulling the hatch shut behind him. The main ballast tank vents were opened and water flooded in. Full negative tanks were flooded for additional weight. The diving planes were angled steeply. The diesel engines were secured and the electric motors engaged.

A well-drilled fleet submarine crew could go from surfaced to periscope depth — roughly 63 feet — in 30 to 60 seconds. Getting those extra few seconds could be the difference between escaping and being bombed. Submariners drilled on the crash dive over and over again until every motion was automatic.

---

### pam_040 — What is a periscope and how was it used?

What is a periscope and how was it used?

A periscope is an optical instrument — essentially a long tube with prisms and lenses — that allows a submarine to observe the surface while remaining underwater. On a fleet submarine, the periscope extended from the conning tower and could be raised up through the hull to just above the waterline, allowing the captain to see the horizon without exposing the boat.

Fleet submarines typically carried two periscopes: a thicker “search” periscope with higher magnification for long-range observation and low-light use, and a thinner “attack” periscope used during torpedo approaches. The attack scope presented a smaller surface signature — less wake, harder for a sharp-eyed lookout to spot.

The captain “shot” periscope bearings by raising the scope for only a few seconds at a time, taking a bearing and range estimate on the target, then immediately lowering it. Extended exposure risked detection. The data was fed into the Torpedo Data Computer in the conning tower, which calculated the torpedo firing solution. The rule was: keep the scope up as little as possible. A careless periscope look was an invitation to a depth charge attack.

---

### pam_041 — What is a conning tower?

What is a conning tower?

On a WWII fleet submarine, the conning tower was a small cylindrical compartment — barely large enough for a handful of men — located between the bridge above and the control room below. It was the nerve center of an attack: the periscopes, the Torpedo Data Computer (TDC), the radar display, and the main helm were all located here.

During a torpedo attack, the captain stood at the periscope in the conning tower while the TDC operator tracked the target and calculated the firing solution. The fire control party — captain, exec, TDC operator, and assistant — worked in very close quarters. It could get intense.

The word “conning tower” is also sometimes used loosely to refer to the entire raised structure above the main deck — the “sail” or “fairwater” — which contains the bridge at the top. Strictly speaking, the conning tower is the pressure hull compartment inside that structure, while the outer shell is called the fairwater. On the Pampanito, you can visit the actual conning tower compartment and see the periscopes and equipment in place.

---

### pam_042 — How did they control the depth of a submarine?

How did they control the depth of a submarine?

A submerged submarine used two systems in combination to control its depth.

The first was buoyancy: by flooding or pumping out water from ballast and trim tanks, the submarine could be made slightly heavier or lighter than the water it displaced. When properly “trimmed,” the boat was in neutral buoyancy at depth, neither rising nor sinking on its own.

The second system was the diving planes — pairs of horizontal fins, one set near the bow and one near the stern. Like the elevators on an airplane, the planes changed the angle of the hull and drove the boat up or down when it was moving forward. The planesmen — usually two sailors sitting side by side in the control room — operated these controls constantly, making small adjustments to hold the ordered depth. Holding a steady depth in rough water or changing thermoclines required constant attention.

The two systems worked together. Ballast and trim tanks gave coarse buoyancy control. The planes gave fine dynamic depth control while the boat was underway.

---

### pam_043 — What were the biggest dangers for submarine crews?

What were the biggest dangers for submarine crews?

The submarine service was the most dangerous assignment in the US Navy during World War II. Roughly one in five US submariners who went on patrol did not return — a casualty rate exceeded by no other branch of the American armed forces.

The primary threat was enemy anti-submarine warfare: destroyer escorts equipped with sonar and depth charges. A depth charge had to explode within about 50 feet to be lethal, but a sustained pattern from multiple destroyers could keep a submarine deep for hours, exhausting batteries and crew alike, until a critical failure forced it up. Enemy aircraft — especially later in the war — caught submarines on the surface and bombed or strafed them.

Mines were another major threat, especially in shallow coastal waters. Other boats were lost to operational accidents: a circular run by a malfunctioning torpedo, a diving casualty in training, or a collision. And there was always the possibility of a patrol going simply “missing” with no known cause — about eight boats fall in that category. Whatever the cause, if you weren’t coming home, no one would know until you were long overdue.

---

### pam_044 — What caused the most submarine losses in WWII?

What caused the most submarine losses in WWII?

Of the 52 US submarines lost in World War II, the single largest cause was enemy anti-submarine warfare — depth charges and bombs from Japanese surface ships and aircraft. Destroyers and destroyer escorts were the submarine’s natural enemy, armed with sonar to track submerged boats and depth charges to attack them.

Mines accounted for a smaller but significant number of losses, particularly in the early part of the war when charting of enemy minefields was incomplete. Some boats were lost entering or exiting enemy harbors and coastal waters.

A handful of submarines were lost to operational accidents — training accidents, diving casualties, or mechanical failures. A few were lost to friendly fire. And for about eight US submarines that disappeared during the war, the cause was never determined, and they remain “lost to causes unknown.” Their crews are carried on the Navy’s rolls as “on eternal patrol.”

Japanese anti-submarine tactics improved significantly as the war progressed. In 1942 and early 1943, very few US submarines were lost. By 1944 and 1945, as Japan’s ASW forces became better equipped and submarines operated increasingly in shallow, confined waters, the loss rate climbed.

---

### pam_045 — Were American torpedo problems fixed during the war?

Were American torpedo problems fixed during the war?

Yes, but it took nearly two years of war and enormous frustration to sort out. The standard US submarine torpedo in 1941 — the Mark 14 — had at least three serious defects, each of which took time to identify and correct.

The first problem was depth-keeping: the Mark 14 ran about 10 feet deeper than set, meaning torpedoes aimed at a ship’s waterline passed harmlessly under the keel. This was confirmed by testing in 1942 and corrected.

The second problem was the Mark 6 magnetic exploder — designed to detonate under a ship’s hull using its magnetic field. It was far too sensitive and detonated prematurely or not at all. Submarines began deactivating it independently in 1943, and the Navy officially ordered it deactivated in October 1943.

The third problem was the contact exploder’s firing pins: when a torpedo struck at a 90-degree angle (a direct hit), the impact was so forceful that the firing pin mechanism crushed instead of firing. This was identified and fixed in mid-1943 with stronger pins and modified angles.

By late 1943 and into 1944, all three fixes were in place. US torpedo reliability improved dramatically, and the submarine force’s effectiveness surged accordingly.

---

### pam_046 — Who was the captain of the Pampanito?

Who was the captain of the Pampanito?

The Pampanito served under two commanding officers during her six war patrols in World War II.

Lieutenant Commander Charles B. Jackson Jr. commanded Pampanito on her first two patrols, beginning when the boat commissioned in November 1943. Under Jackson, Pampanito conducted patrols in the Western Pacific and established herself as an effective boat.

Lieutenant Commander Paul E. Summers took command before the third patrol and led Pampanito through patrols three, four, five, and six. Summers commanded the boat during its most famous action: the September 1944 patrol in which Pampanito, operating with a wolf pack, helped attack a Japanese convoy — and then discovered that the convoy was carrying British and Australian prisoners of war. Pampanito rescued 73 men from the water in one of the most dramatic humanitarian missions in submarine history. Summers was awarded the Navy Cross for this patrol.

Both commanders were decorated for their service. The Pampanito was awarded six battle stars for her WWII service.

---

### pam_047 — What is the silent service?

What is the silent service?

“The Silent Service” is the traditional nickname for the United States submarine force. The name has two meanings, both rooted in how submarines operated in World War II.

The first meaning is tactical. Submarines depended on silence and stealth. They operated alone, deep, and invisible. Every sound the crew made could be heard by enemy sonar. When submerged and evading, crew members spoke in whispers, removed their shoes, and tiptoed through the boat. The machinery was quieted as much as possible. The submarine’s survival depended on being quieter than the water around it.

The second meaning is institutional. Submarine operations were classified. Crews returning from patrol could not tell their families where they had been, what they had done, or what ships they had sunk. A submariner could not explain why he couldn’t talk about his service; he could only say he couldn’t. The men came home, said nothing, and went out again. For years after the war, much of the submarine record remained classified.

Together, those two meanings — tactical stealth and institutional secrecy — gave the submarine force its enduring name.

---

### pam_048 — How old were the men who served on submarines?

How old were the men who served on submarines?

Submarine crews during World War II were young by any measure. Enlisted men were typically 17 to 24 years old, with many in their late teens or early twenties. Officers were somewhat older — ensigns fresh from submarine school might be 22 or 23, while a commanding officer was usually in his late twenties or early thirties. By the standards of other military commands, submarine captains were very young men.

All submarine service was voluntary. The Navy screened heavily for physical fitness, mental aptitude, and temperament. Men had to pass a demanding physical examination — good eyesight, hearing, and psychological screening for tolerance of confined spaces. Then they had to complete submarine school and actually earn their qualifications at sea.

The youth of the crews is perhaps surprising given the demands placed on them. These were teenagers and young men in their early twenties operating some of the most complex fighting machinery of the era, in life-or-death situations, far from home on patrols lasting two months. Veterans who survived the war often speak of being astonished, in retrospect, at how young they were — and how little they worried about it at the time.

---

### pam_049 — Were there African American sailors on WWII submarines?

Were there African American sailors on WWII submarines?

During World War II, the US Navy was racially segregated. African American sailors were largely confined to the messman and steward branches — the cooks and personal servants for officers — across all seagoing branches, including submarines. Very few Black sailors served in technical or combat roles in the submarine force during the war.

The submarine service reflected the Navy’s broader segregation policy, established by regulations and reinforced by long-standing tradition. Even those African American sailors who did serve aboard submarines in steward roles often faced discrimination in shore facilities and port towns.

President Truman’s Executive Order 9981 in 1948 mandated integration of all armed forces, and the Navy moved toward full integration in the early 1950s. Today the submarine force is fully integrated throughout its ranks, and women have served on submarines since 2010.

---

### pam_050 — How did submarines get fuel and supplies during a patrol?

How did submarines get fuel and supplies during a patrol?

US fleet submarines were largely self-sufficient for the duration of a war patrol — typically 45 to 75 days. They departed with full fuel tanks, a full torpedo load, and enough food to feed 80 men for the patrol. Replenishment at sea was possible but not routine.

The primary supply bases were Pearl Harbor, Hawaii, and — as the war advanced westward — Midway Atoll, Majuro, Guam, and other forward bases. Submarine tenders — large ships like USS Fulton or USS Proteus — were moored at these bases and served as floating machine shops, supply depots, and rest facilities for crews between patrols. When a submarine returned from patrol, the tender took care of everything: fuel, torpedoes, food, spare parts, and repair of any damage.

At-sea transfers from tenders or other submarines were technically possible and occasionally done for special missions but were logistically complex and risky. For a normal war patrol, the submarine carried everything it needed and relied on nothing until it returned to port.

---

### pam_051 — What does it smell like inside a submarine?

What does it smell like inside a submarine?

Veterans who served on WWII submarines are remarkably consistent in their answer: diesel fuel and unwashed men, with various undertones depending on where in the boat you were.

The dominant smell was diesel. The engines were inside the boat, the fuel was in tanks throughout the hull, and every surface absorbed the smell of petroleum over time. Clothes, blankets, food — everything took on a diesel-and-oil character after a few days at sea. The engine rooms were the worst, but the smell permeated the entire boat.

Add to that: 80 men in a sealed metal tube for two months with almost no fresh water for bathing, no laundry, and cooking happening around the clock. When the submarine was charging batteries, hydrogen gas from the battery cells added a sharp chemical note. The galley contributed cooking smells. In the after battery room, where many of the crew bunked, a faint battery acid smell was always present.

Long-time veterans say they stopped noticing it after a day or two. The sailors on the dock welcoming a returning submarine noticed it very clearly from a distance.

---

### pam_052 — How did submarine crews get mail from home?

How did submarine crews get mail from home?

While a submarine was at sea on patrol, there was no mail delivery. The boat was completely radio-silent except for receiving encoded operational messages, and those messages carried no personal correspondence. For 60 or 70 days at sea, a submariner had no news from home whatsoever.

Mail sent to submarines was held at the submarine base — usually addressed to the boat’s name in care of Fleet Post Office. When the submarine returned from patrol and tied up to the submarine tender, weeks of accumulated letters and packages were waiting.

The volume of letters a man received on return from patrol was often very large, and it was common to spend the first day or two just reading. For crewmen with wives, children, or parents back home, those letters were a lifeline to the world they had left behind.

Families were told to write frequently because letters would arrive in batches — but they had no reliable way to know when their sailor was due back, or whether he was still alive. The uncertainty was one of the hardest parts for families.

---

### pam_053 — What happened when a submarine returned to port?

What happened when a submarine returned to port?

Returning from a war patrol was one of the defining experiences of submarine service. After 60 or more days at sea, the boat tied up to its submarine tender, and the transition from patrol to port began immediately.

The first pleasures were simple and powerful: fresh milk, fresh fruit, fresh baked bread — food that had no place on a patrol, where everything was canned or frozen. A hot shower. A real bed that didn’t move. A beer ration issued by the Navy. The submarine tender’s crew took over the boat for repairs and provisioning, and the submarine’s crew was free to rest.

A formal debriefing followed, where the officers reported the patrol’s results and any intelligence observations. Then came a rest period — typically two weeks at a rest camp at a location like the Royal Hawaiian Hotel in Honolulu, or a camp on Guam or Midway. Swimming, food, drinks, and sleep.

After rest, the crew returned to the tender to supervise the reloading of torpedoes, provisioning, and repairs before the next patrol began. The cycle — patrol, rest, prepare, patrol again — continued until the war ended or the boat was lost.

---

### pam_054 — What is a wolf pack?

What is a wolf pack?

A wolf pack is a coordinated group of submarines assigned to attack the same convoy or patrol area together. The tactic was pioneered by Germany’s Admiral Karl Dönitz, who used large packs of U-boats in the Atlantic to overwhelm convoy defenses that could only track one submarine at a time.

The US Navy developed its own version, called “coordinated attack groups,” typically two to four submarines working together. Unlike the German wolf packs, which were directed by a shore headquarters, American groups operated with more independence, coordinating by radio once contact was made. The idea was the same: while the escorts chased one submarine, the others could attack from different directions.

The Pampanito participated in a coordinated attack group on its famous third war patrol in September 1944, operating with USS Growler (SS-215) and USS Sealion II (SS-315). They attacked a Japanese convoy — and that attack led directly to the discovery of hundreds of British and Australian prisoners of war in the water, setting off the dramatic rescue for which the Pampanito is best known.

American wolf packs contributed significantly to the destruction of Japan’s merchant fleet, cutting off the supply lines that kept Japan’s island garrisons and war economy alive.

---

### pam_055 — Did the Pampanito rescue people from the ocean?

Did the Pampanito rescue people from the ocean?

Yes — it is one of the most dramatic rescue operations in submarine history. On its third war patrol in September 1944, the Pampanito was part of a wolf pack that attacked Japanese convoy HI-72 in the South China Sea. What the submarines did not know at the time was that two ships in the convoy — the Rakuyo Maru and Kachidoki Maru — were carrying over 2,200 British and Australian prisoners of war being transported to labor camps.

After the attack, Pampanito surfaced and began finding survivors in the water — gaunt, oil-covered men who turned out to be Allied POWs. Commander Paul Summers began pulling men aboard immediately. Over the course of about nine hours, Pampanito rescued 73 British and Australian survivors. USS Sealion II rescued an additional 54. Other submarines and surface ships reached the area and rescued more.

Of the 2,200 POWs who had been aboard those ships, approximately 159 were rescued. The rest perished — many drowned; others died in the days after rescue from the effects of years of brutal captivity. Pampanito carried her 73 survivors back to port, with the injured crowding every available space on the boat. The rescue is memorialized in the exhibits aboard the Pampanito today.

---

### pam_056 — What happened to men who were killed on a submarine patrol?

What happened to men who were killed on a submarine patrol?

If a sailor died while the submarine was at sea on patrol — from combat injury, accident, or illness — he was buried at sea. There was no option to preserve the body or return it to port: submarines had no morgue, and a 60-day patrol left no practical alternative. The captain would conduct a brief ceremony, and the man would be committed to the ocean.

For families at home, the process was agonizing in its uncertainty. The Navy did not broadcast results from individual submarines, and any message home would have compromised operational security. Families received only a telegram from the Navy when a man’s status changed. If a submarine went missing and was overdue, the families of every man aboard received a “missing in action” notification — but no explanation and no certainty.

Of the 52 US submarines lost in World War II, most were lost with all hands, their crews still aboard somewhere in the Pacific. The submarine community calls them “on eternal patrol.” In total, approximately 3,500 US submariners died in the war — the highest loss rate, per capita, of any branch of the American armed forces.

---

### pam_057 — What happened to the Japanese submarine force in WWII?

What happened to the Japanese submarine force in WWII?

Japan entered World War II with one of the largest submarine fleets in the world — over 60 ocean-going submarines, with more under construction. In some respects Japanese submarines were technically impressive, and Japanese torpedoes (the oxygen-powered Type 91 and Type 95) were among the best in the world.

But the Imperial Japanese Navy made a strategic choice that limited its submarines’ impact: instead of using them primarily against Allied merchant shipping — the approach that strangled Japan’s own supply lines — Japanese doctrine emphasized attacks on warships. They achieved notable successes (the heavy cruiser Indianapolis was sunk by submarine I-58 in July 1945, one of the worst naval disasters in US history), but Japanese submarines never seriously threatened Allied supply lines across the Pacific.

As the war progressed, Japanese submarines were increasingly diverted to supply missions — resupplying isolated island garrisons that could no longer be reached by surface ship. This consumed much of their offensive potential.

By the war’s end, the vast majority of Japan’s submarine fleet had been sunk by US destroyers and aircraft, aided by Allied signals intelligence that often revealed their positions.

---

### pam_058 — How did US submarines compare to German U-boats?

How did US submarines compare to German U-boats?

American fleet submarines and German U-boats were the two most effective submarine forces of World War II, but they were built for very different purposes and operated in completely different theaters.

US fleet submarines like the Pampanito were much larger: about 310 feet long with a displacement of over 1,500 tons submerged, compared to roughly 220 feet and 870 tons for the standard German Type VIIC U-boat. The greater size gave US submarines much longer range (over 11,000 miles on the surface), better habitability, and air conditioning that made long Pacific patrols bearable in tropical heat.

German U-boats were purpose-built for the North Atlantic — shorter-range operations from European bases against dense convoy routes. They operated in large wolf packs of 10 to 20 submarines directed from shore headquarters, with tight coordination. Germany built nearly 1,000 U-boats during the war, compared to about 200 US fleet submarines.

Both forces were devastating in their own theaters. US submarines sank approximately 55% of all Japanese merchant tonnage, strangling Japan’s ability to fuel and supply its forces. German U-boats sank over 3,000 Allied ships. Both paid heavily: Germany lost over 700 U-boats and roughly 30,000 men; the US lost 52 submarines and about 3,500 men.

---

### pam_059 — How many men were on a submarine crew?

How many men were on a submarine crew?
...
### pam_060 — What is a crash dive?

What is a crash dive?

A crash dive is an emergency dive — practiced constantly until the entire crew could execute it in their sleep. Typically triggered by a sighting of an enemy aircraft or surface ship, the goal was to get below the surface as fast as possible.
...
### pam_061 — How many American submarines were lost in WWII?
...
### pam_062 — Did submarines ever rescue survivors from the water?

Did submarines ever rescue survivors from the water?
...
### pam_063 — Did the Pampanito save the POWs?

Did the Pampanito save the POWs?
...
### pam_064 — How did you flush a toilet on a submarine?
...
### pam_065 — How did submarines run underwater without air for the engines?

How did submarines run underwater without air for the engines?
...
### pam_066 — Why did submarines stay on the surface at night?

Why did submarines stay on the surface at night?
