...
If someone who owns a video asks us to stop showing it, take it down first and
sort out the details afterwards. It takes about a minute and needs no technical
knowledge. Nothing here can break the website.

## The One Page You Need

**<https://submarinedocent.org/web/edit_videos.html>**
...
- **The written answer stays exactly as it was.** Removing a video from a
  question deletes only the video. The text a visitor reads is untouched.
- **The credit and caption go with it.** You don't need to tidy up anything
  afterwards.
- **It cannot be undone with a button.** There's no undo. If you remove
  something by mistake, it can be added back — you'll need the video's web
  address, and for a hosted file that address is still in the R2 bucket. Ask
  whoever maintains the site.

## If You Can't Find It

A video might also be:
...
> Thank you for letting us know. I've removed the video from our site as of
> today. Please let me know if you see it anywhere else and I'll take care of
> that too.

Don't argue the point or ask them to reconsider. If they later change their
mind, we can always put it back.

## Related

- [AddingVideos.md](AddingVideos.md) — how videos get added, and the rights
  questions to settle before adding one.
